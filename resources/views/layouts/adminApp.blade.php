...
<script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    ...
    <body class="h-[200vh] text-white">
        <div class="flex justify-between space-x-3">
            <div class="w-1/6">
                <div class="fixed left-0 w-1/6  flex-col  h-screen space-y-3 bg-black ">
                    ...
                    <div class="flex flex-col space-y-3 justify-center h-1/3">
                        <a href="" class="text-default font-medium hover:bg-white hover:text-black p-3 text-white border-b-2 border-white">TEST</a>
                        <a href="" class="text-default font-medium hover:bg-white hover:text-black p-3 text-white border-b-2 border-white">TEST</a>
                        <a href="" class="text-default font-medium hover:bg-white hover:text-black p-3 text-white border-b-2 border-white">TEST</a>
                        <a href="" class="text-default font-medium hover:bg-white hover:text-black p-3 text-white border-b-2 border-white">TEST</a>
                    </div>
                    <div class="flex w-full flex-col mt-4 h-2/6 justify-end">
                        <a href="/" class="text-default font-medium p-3">Store Page</a>
                        <a href="#" class="text-default font-medium p-3">Logout</a>
                    </div>
                </div>
            </div>
